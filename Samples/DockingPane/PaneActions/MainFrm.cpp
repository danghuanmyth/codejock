...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND_RANGE(ID_ACTIONS_CLASSVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_CLASSVIEW_CANCEL_ACTIONUNPINNING, OnActionsClassviewCancel)
	ON_UPDATE_COMMAND_UI_RANGE(ID_ACTIONS_CLASSVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_CLASSVIEW_CANCEL_ACTIONUNPINNING, OnUpdateActionsClassviewCancel)
	...
	ON_COMMAND_RANGE(ID_ACTIONS_RESOURCEVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_RESOURCEVIEW_CANCEL_ACTIONUNPINNING, OnActionsResourceviewCancel)
	ON_UPDATE_COMMAND_UI_RANGE(ID_ACTIONS_RESOURCEVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_RESOURCEVIEW_CANCEL_ACTIONUNPINNING, OnUpdateActionsResourceviewCancel)
	...
	ON_COMMAND_RANGE(ID_ACTIONS_FILEVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_FILEVIEW_CANCEL_ACTIONUNPINNING, OnActionsFileviewCancel)
	ON_UPDATE_COMMAND_UI_RANGE(ID_ACTIONS_FILEVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_FILEVIEW_CANCEL_ACTIONUNPINNING, OnUpdateActionsFileviewCancel)
	...
	ON_COMMAND_RANGE(ID_ACTIONS_INFOVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_INFOVIEW_CANCEL_ACTIONUNPINNING, OnActionsInfoviewCancel)
	ON_UPDATE_COMMAND_UI_RANGE(ID_ACTIONS_INFOVIEW_CANCEL_ACTIONFLOATING, ID_ACTIONS_INFOVIEW_CANCEL_ACTIONUNPINNING, OnUpdateActionsInfoviewCancel)
	...
	ON_COMMAND_RANGE(ID_ACTIONS_ALL_CANCEL_ACTIONFLOATING, ID_ACTIONS_ALL_CANCEL_ACTIONUNPINNING, OnActionsAllCancel)
	ON_UPDATE_COMMAND_UI_RANGE(ID_ACTIONS_ALL_CANCEL_ACTIONFLOATING, ID_ACTIONS_ALL_CANCEL_ACTIONUNPINNING, OnUpdateActionsAllCancel)
...
void CMainFrame::OnActionsAllFlags(UINT nID)
{
	...
	while (pos)
	{
		...
		DWORD dwOptions = pPane->GetOptions();
		if (bSet) dwOptions &= ~ nFlag; else dwOptions |= nFlag;
		pPane->SetOptions(dwOptions);
	}
