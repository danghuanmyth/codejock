...
void CPropertyGridDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHK_MARKUP, m_bMarkup);
...
BEGIN_MESSAGE_MAP(CPropertyGridDlg, CPropertyGridDlgBase)
	...
	ON_BN_CLICKED(IDC_CHK_MARKUP, OnClickedChkMarkup)
...
BOOL CPropertyGridDlg::OnInitDialog()
{
	...
	if ( m_wndPropertyGrid.Create( rc, this, IDC_PROPERTY_GRID ) )
	{
		...
		pItemSaveOnClose->SetID(ID_ITEM_SAVE_ON_CLOSE);
	...
	SetResize(IDC_GBOX_APPEAR,       XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_TOOLBAR,       XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_HELP,          XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_VERBS,         XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_DOUBLE,        XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_TABITEMS,      XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_HIGHLIGHT,     XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_COMBO_THEME,       XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_GBOX_SORT,         XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_SORT_CATEGORIES,   XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_SORT_ALPHABETICAL, XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_SORT_NOSORT,       XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_GBOX_COLOR,        XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_CUSTOMCOLORS,  XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_MARKUP,        XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_BUTTON_SWITCHSTATE,  XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_COMBO_BORDER,      XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHECK_SHOWBUTTONS, XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_CHK_RIGHTTOLEFT, XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
...
void CPropertyGridDlg::OnClickedChkMarkup()
{
	UpdateData();

	m_wndPropertyGrid.EnableMarkup(m_bMarkup);

	CXTPPropertyGridItem *pItemSaveOnClose = m_wndPropertyGrid.FindItem(ID_ITEM_SAVE_ON_CLOSE);
	CXTPPropertyGridItem *pItemLanguage	   = m_wndPropertyGrid.FindItem(ID_ITEM_VERSION_LANGUAGE);
