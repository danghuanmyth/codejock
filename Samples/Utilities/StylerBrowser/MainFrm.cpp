...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//XTPResourceImages()->SetHandle(_T("Styles\\Office2007Gray.dll"));
	...
	m_MTIClientWnd.ShowNewWindowTab(TRUE, ID_FILE_NEW_BLANK);
...
void CMainFrame::SetTheme(XTPPaintTheme theme)
{
	...
	m_paneManager.SetTheme(
		...
		m_themeCurrent == xtpThemeOfficeXP ? xtpPaneThemeVisualStudio2003: 
		m_themeCurrent == xtpThemeOffice2003 ? xtpPaneThemeOffice2003: 
		m_themeCurrent == xtpThemeResource ? xtpPaneThemeResource: 
		m_themeCurrent == xtpThemeRibbon ? xtpPaneThemeResource: 
		m_themeCurrent == xtpThemeWhidbey ? xtpPaneThemeVisualStudio2005: 
			xtpPaneThemeWinNative);

	CXTPPaintManager::SetTheme(theme);

	EnableOffice2007Frame(theme == xtpThemeRibbon || theme == xtpThemeResource ? GetCommandBars() : 0);
