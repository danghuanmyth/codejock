...
class CSearchBrowseButton : public CXTPBrowseButton
{
public:
...
class CSearchOptionsView : public CXTPResizeFormView
{
protected:
...
public:
	...
	CXTPResizeGroupBox   m_wndGroupFindOptions;
	//}}AFX_DATA
	BOOL m_bInitialized;
	CFont m_fontRegular;
// Attributes
public:
	...
	CComboBox m_cmbFile;
	CSearchBrowseButton m_btnFileExpand;
...
protected:
	...
	afx_msg void OnToolbarButton(UINT nCmd);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
