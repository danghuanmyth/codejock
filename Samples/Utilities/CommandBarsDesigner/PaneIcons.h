...
class CPaneIcons : public CPaneHolder
{
// Construction
public:
	CPaneIcons();
...
public:
	...
	CResourceManager* m_pActiveResourceManager;
	...
	void ShowIcons(CXTPImageManager* pImageManager, int nActive, CResourceManager* pResourceManager);
