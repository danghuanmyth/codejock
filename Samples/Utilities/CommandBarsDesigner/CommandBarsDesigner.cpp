...
BOOL CCommandBarsDesignerApp::InitInstance()
{
	...
	CString strValue = _T("Codejock Command Bars Designer Document");

	BOOL bUserHasPermissions =  ::RegSetValue(hKeyTemp, _T("{D87BE4B3-AF03-44B7-A307-84820060A4C5}"), REG_SZ,
		strValue, (int) _tcslen(strValue) * sizeof(TCHAR)) != ERROR_ACCESS_DENIED;
