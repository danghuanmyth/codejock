...
public:
	...
	void RefreshControlProperties(CXTPControl* pControl);
	void RefreshDragProperties();
	
	void RefreshRibbonTabProperties(CXTPRibbonTab* pDragControl);
	void RefreshRibbonGroupProperties(CXTPRibbonGroup* pGroup);
	...
	void OnTabValueChanged(CXTPRibbonTab* pTab, CXTPPropertyGridItem* pItem);
	void OnGroupValueChanged(CXTPRibbonGroup* pTab, CXTPPropertyGridItem* pItem);
