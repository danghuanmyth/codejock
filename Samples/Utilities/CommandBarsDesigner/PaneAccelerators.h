...
class CPaneAccelerators : public CPaneHolder
{
...
public:
	...
	CXTPShortcutManagerAccelTable* m_pAccelTable;

	CXTPToolBar m_wndToolBar;

	void Refresh(BOOL bForceAll = FALSE);
	void RefreshAccels(CXTPShortcutManagerAccelTable* pAccelTable);

	CXTPShortcutManagerAccelTable* GetActiveAccelTable();
