...
//MD - test 
	//CXTPCalendarEventCategories* pEventCategories =  pData->GetEventCategories();
	//if (pEventCategories)
	//{
	//	CXTPCalendarEventCategory* pEventCategory = 
	//		new CXTPCalendarEventCategory(20, _T("Servers"), RGB(255,0,0), RGB(0,0,255));
	//	pEventCategories->Add(pEventCategory);
	//}
	//CXTPCalendarEventLabels* pEventLabels = pData->GetLabelList();
	//if (pEventLabels)
	//{
	//	CXTPCalendarEventLabel* pLabel0 = pEventLabels->GetAt(0);

	//	CXTPCalendarEventLabel* pLabel = new CXTPCalendarEventLabel(0, RGB(200, 100, 50), 
	//		_T("Servers"));
	//	pEventLabels->SetAt(0, pLabel);
	//}
//MD
	// ** schedules
