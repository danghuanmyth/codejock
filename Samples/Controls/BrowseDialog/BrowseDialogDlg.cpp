...
CBrowseDialogDlg::CBrowseDialogDlg(CWnd* pParent /*=NULL*/)
	: CXTPResizeDialog(CBrowseDialogDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CBrowseDialogDlg, CXTPResizeDialog)
...
BOOL CBrowseDialogDlg::OnInitDialog()
{
	...
	SetResize(IDC_BTN_BROWSE, XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
