...
CMaskHelpDlg::CMaskHelpDlg(CWnd* pParent /*=NULL*/)
	: CXTPResizeDialog(CMaskHelpDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CMaskHelpDlg, CXTPResizeDialog)
...
BOOL CMaskHelpDlg::OnInitDialog()
{
	...
	m_pHelpView = ( CHelpView* )XTPCreateView( this, RUNTIME_CLASS( CHelpView ) );
	...
	SetResize(AFX_IDW_PANE_FIRST, XTP_ANCHOR_TOPLEFT,  XTP_ANCHOR_BOTTOMRIGHT);
