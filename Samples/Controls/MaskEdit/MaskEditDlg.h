...
class CMaskEditDlg : public CXTPResizeDialog
{
// Construction
public:
...
// Dialog Data
	...
	CEdit   m_editPrompt;
	CButton m_btnHelp;
	CXTPEdit m_editLiteral;
	CXTPEdit m_editMask;
	CXTPEdit m_editDefault;
	CXTPListBox  m_lboxMask;
	CXTPMaskEdit m_editMaskEdit;
	CString m_strEditMask;
	CString m_strLiteral;
	CString m_strDefault;
	BOOL    m_bDefault;
	CString m_strPrompt;
	CXTPResizeGroupBox m_grpProperties;
	//}}AFX_DATA
