...
CBrowseEditDlg::CBrowseEditDlg(CWnd* pParent /*=NULL*/)
	: CXTPResizeDialog(CBrowseEditDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CBrowseEditDlg, CXTPResizeDialog)
...
BOOL CBrowseEditDlg::OnInitDialog()
{
	...
	m_editMenu.Initialize(this, BES_XTP_POPUPMENU, IDR_POPUP);
	m_editDir.Initialize(this, BES_XTP_CHOOSEDIR);
	m_editFile.Initialize(this, BES_XTP_CHOOSEFILE);
	...
	SetResize(IDC_EDIT_FILE, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_EDIT_DIR, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_EDIT_MENU, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_TOPRIGHT);
