...
CCheckListBoxDlg::CCheckListBoxDlg(CWnd* pParent /*=NULL*/)
	: CXTPResizeDialog(CCheckListBoxDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CCheckListBoxDlg, CXTPResizeDialog)
...
BOOL CCheckListBoxDlg::OnInitDialog()
{
	...
	SetResize(IDC_LBOX_CHECK, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_BTN_NEW, XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_BTN_RENAME, XTP_ANCHOR_TOPRIGHT, XTP_ANCHOR_TOPRIGHT);
