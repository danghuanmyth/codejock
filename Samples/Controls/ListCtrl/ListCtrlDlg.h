...
class CListCtrlDlg : public CXTPResizeDialog
{
// Construction
public:
...
// Dialog Data
	...
	CXTPColorPicker      m_cpSortText;
	CXTPColorPicker      m_cpSortBack;
	CXTPColorPicker      m_cpListText;
	CXTPColorPicker      m_cpListBack;
	CXTPColorPicker      m_cpRowText;
	CXTPColorPicker      m_cpRowBack;
	CXTPResizeGroupBox   m_gboxList;
	CXTPResizeGroupBox   m_gboxHeader;
