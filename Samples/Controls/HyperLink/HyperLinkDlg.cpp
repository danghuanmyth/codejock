...
CHyperLinkDlg::CHyperLinkDlg(CWnd* pParent /*=NULL*/)
	: CXTPResizeDialog(CHyperLinkDlg::IDD, pParent)
{
...
void CHyperLinkDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_XTPColorPicker(pDX, IDC_CLR_LINK, m_clrLink);
	DDX_XTPColorPicker(pDX, IDC_CLR_HOVER, m_clrHover);
	DDX_XTPColorPicker(pDX, IDC_CLR_VISITED, m_clrVisited);
}

BEGIN_MESSAGE_MAP(CHyperLinkDlg, CXTPResizeDialog)
	...
	//}}AFX_MSG_MAP
	ON_CPN_XTP_SELENDOK(IDC_CLR_LINK, OnSelEndOkColor)
	ON_CPN_XTP_SELENDOK(IDC_CLR_HOVER, OnSelEndOkColor)
	ON_CPN_XTP_SELENDOK(IDC_CLR_VISITED, OnSelEndOkColor)
END_MESSAGE_MAP()
...
BOOL CHyperLinkDlg::OnInitDialog()
{
	...
	SetResize(IDC_HYP_TEXT, XTP_ANCHOR_TOPLEFT,     XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_EDIT_TXT, XTP_ANCHOR_TOPLEFT,     XTP_ANCHOR_TOPRIGHT);
	SetResize(IDC_EDIT_URL, XTP_ANCHOR_TOPLEFT,     XTP_ANCHOR_TOPRIGHT);
