...
#ifndef _XTP_INCLUDE_TASKPANEL
	GetDlgItem(IDC_BUTTON_TASKPANEL)->EnableWindow(FALSE); // Not supported without TaskPanel
#endif
...
class CPropertyPageTaskPanelNavigator : public CXTPOfficeBorder<CXTPTaskPanel>, public CXTPPropertyPageControlNavigator
{
public:
	CPropertyPageTaskPanelNavigator();
...
public:
	...
	{
		return GetXtremeColor(COLOR_3DSHADOW);
	}
...
void CPropertyPageTaskPanelNavigator::OnPageChanged()
{
	GetGroups()->Clear(FALSE);
