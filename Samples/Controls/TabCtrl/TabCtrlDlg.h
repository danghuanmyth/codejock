...
/////////////////////////////////////////////////////////////////////////////
// CEditListBoxEx helper class to handle sizing for CXTPTabCtrl.

class CEditListBoxEx : public CXTPEditListBox
{
public:
...
class CTabCtrlEx : public CXTPTabCtrl
{
...
class CTabCtrlDlg : public CXTPResizeDialog
{
// Construction
public:
...
// Dialog Data
	...
	CXTPNoFlickerWnd <CButton> m_chkVertical;
	CXTPNoFlickerWnd <CButton> m_chkMultiline;
	CXTPNoFlickerWnd <CButton> m_chkAutoCondense;
