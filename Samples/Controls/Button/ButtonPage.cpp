...
CButtonPage::CButtonPage()
	: CXTPResizePropertyPage(CButtonPage::IDD)
{
...
BEGIN_MESSAGE_MAP(CButtonPage, CXTPResizePropertyPage)
	...
	ON_BN_CLICKED(IDC_RADIO_NATIVEWINXP, OnRadTheme)
...
void CButtonPage::OnRadTheme() 
{
	...
	SendMessageToDescendants(WM_XTP_SETCONTROLTHEME, (XTPControlTheme)m_nTheme);
