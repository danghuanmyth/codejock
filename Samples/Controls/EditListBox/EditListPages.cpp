...
CEditListPage1::CEditListPage1() : CXTPResizePropertyPage(CEditListPage1::IDD)
{
...
IMPLEMENT_DYNCREATE(CEditListPage1, CXTPResizePropertyPage)

BEGIN_MESSAGE_MAP(CEditListPage1, CXTPResizePropertyPage)
	...
	//}}AFX_MSG_MAP
	ON_LBN_XTP_LABELEDITEND(IDC_EDIT_LIST, OnLabelEditEnd)
	ON_LBN_XTP_LABELEDITCANCEL(IDC_EDIT_LIST, OnLabelEditCancel)
	ON_LBN_XTP_NEWITEM(IDC_EDIT_LIST, OnNewItem)
	ON_LBN_XTP_DELETEITEM(IDC_EDIT_LIST, OnDeleteItem)
	ON_LBN_XTP_MOVEITEMUP(IDC_EDIT_LIST, OnMoveItemUp)
	ON_LBN_XTP_MOVEITEMDOWN(IDC_EDIT_LIST, OnMoveItemDown)
END_MESSAGE_MAP()
...
BOOL CEditListPage1::OnInitDialog()
{
	...
	m_edit1.Initialize(this, BES_XTP_CHOOSEFILE);
	...
	// Call CXTPBrowseEdit::SetListEditStyle to set the popup menu for the
	// browse edit objects.
	m_edit2.Initialize(this, BES_XTP_POPUPMENU, IDR_POPUP, 0);
	m_edit3.Initialize(this, BES_XTP_POPUPMENU, IDR_POPUP, 1);

	// Call CXTPEditListBox::SetListEditStyle to set the type of edit list. You can
	// pass in LBS_XTP_NOTOOLBAR if you don't want the toolbar displayed.
	...
	SetResize(IDC_EDIT_LIST, XTP_ANCHOR_TOPLEFT, XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_TXT_EDIT1, XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMLEFT);
	SetResize(IDC_EDIT1, XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_TXT_EDIT2, XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMLEFT);
	SetResize(IDC_EDIT2, XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_TXT_EDIT3, XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMLEFT);
	SetResize(IDC_EDIT3, XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_CHK_ENABLE, XTP_ANCHOR_BOTTOMRIGHT, XTP_ANCHOR_BOTTOMRIGHT);
...
CEditListPage2::CEditListPage2() : CXTPResizePropertyPage(CEditListPage2::IDD)
{
...
IMPLEMENT_DYNCREATE(CEditListPage2, CXTPResizePropertyPage)

BEGIN_MESSAGE_MAP(CEditListPage2, CXTPResizePropertyPage)
...
BOOL CEditListPage2::OnInitDialog()
{
	...
	m_editList.SetListEditStyle(
		_T(" Search for Files:"), LBS_XTP_CHOOSEFILE);
...
CEditListPage3::CEditListPage3() : CXTPResizePropertyPage(CEditListPage3::IDD)
{
...
IMPLEMENT_DYNCREATE(CEditListPage3, CXTPResizePropertyPage)

BEGIN_MESSAGE_MAP(CEditListPage3, CXTPResizePropertyPage)
...
BOOL CEditListPage3::OnInitDialog()
{
	...
	// pass in LBS_XTP_NOTOOLBAR if you don't want the toolbar displayed.
	m_editList.SetListEditStyle(
		_T(" Search for Directories:"), LBS_XTP_CHOOSEDIR);
