...
IMPLEMENT_DYNAMIC(CEditListSheet, CXTPResizePropertySheet)

CEditListSheet::CEditListSheet(CWnd* pWndParent)
	: CXTPResizePropertySheet(IDS_PROPSHT_CAPTION, pWndParent)
{
...
BEGIN_MESSAGE_MAP(CEditListSheet, CXTPResizePropertySheet)
...
void CEditListSheet::OnSysCommand(UINT nID, LPARAM lParam)
{
	...
	{
		CXTPResizePropertySheet::OnSysCommand(nID, lParam);
	}
}
...
void CEditListSheet::OnPaint()
{
	...
	{
		CXTPResizePropertySheet::OnPaint();
	}
}
...
{
	BOOL bRet = CXTPResizePropertySheet::OnInitDialog();
...
void CEditListSheet::OnDestroy()
{
	...
	CXTPResizePropertySheet::OnDestroy();
}
