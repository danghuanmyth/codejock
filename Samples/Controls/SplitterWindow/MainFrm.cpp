...
void CMainFrame::OnSplitNofulldrag()
{
	...
	m_wndSplitter.EnableFullDrag(m_bFullDrag);
}
...
void CMainFrame::OnSplitDottracker()
{
	...
	m_wndSplitter.EnableDotTracker(m_bDotTrack);
}
...
void CMainFrame::OnSplitNosize()
{
	...
	m_wndSplitter.EnableNoSize(m_bNoSizing);
}
...
{
	pCmdUI->SetCheck(m_iTheme == xtpControlThemeOfficeXP ? 1 : 0);
}
