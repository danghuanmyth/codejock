...
CTreeCtrlDlg::CTreeCtrlDlg(CWnd* pParent /*=NULL*/)
	: CXTPResizeDialog(CTreeCtrlDlg::IDD, pParent), m_pTreeFocus(NULL)
{
...
IMPLEMENT_DYNAMIC(CTreeCtrlDlg, CXTPResizeDialog)

BEGIN_MESSAGE_MAP(CTreeCtrlDlg, CXTPResizeDialog)
...
BOOL CTreeCtrlDlg::OnInitDialog()
{
	...
	SetResize(IDC_TREE_SELECT,    XTP_ANCHOR_TOPLEFT,     XTP_ANCHOR_BOTTOMCENTER);
	SetResize(IDC_TREE_STATE,     XTP_ANCHOR_TOPCENTER,   XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_TXT_STATE,      XTP_ANCHOR_TOPCENTER,   XTP_ANCHOR_TOPCENTER);
	SetResize(IDC_STATIC_SEP,     XTP_ANCHOR_BOTTOMLEFT,  XTP_ANCHOR_BOTTOMRIGHT);
	SetResize(IDC_BTN_PROPERTIES, XTP_ANCHOR_BOTTOMRIGHT, XTP_ANCHOR_BOTTOMRIGHT);
	...
	m_treeSelect.SetFont(&XTPAuxData().font);
...
void CTreeCtrlDlg::SetTreeFocus(CXTPTreeCtrl* pTreeFocus)
{
