...
IMPLEMENT_DYNCREATE(CTaskPanelView, CXTPListView)

BEGIN_MESSAGE_MAP(CTaskPanelView, CXTPListView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, CXTPListView::OnFilePrintPreview)
END_MESSAGE_MAP()
...
void CTaskPanelView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	...
	CXTPListView::OnKeyDown(nChar, nRepCnt, nFlags);
}
