...
BEGIN_MESSAGE_MAP(CShellListCtrl, CXTPShellListCtrl)
...
void CShellListCtrl::RefreshList()
{
	...
	SendMessage( WM_XTP_SHELL_NOTIFY,
		( WPARAM )SHN_XTP_TREESELCHANGE, ( LPARAM )pObject );
}
...
BOOL CShellListCtrl::IsItemFiltered(LPCTSTR lpszItemName, ULONG ulItemAttrs)
{
	...
	return CXTPShellListCtrl::IsItemFiltered(lpszItemName, ulItemAttrs);
}