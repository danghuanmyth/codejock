...
protected:
	...
	afx_msg void OnUpdateBackNoColor(CCmdUI* pCmdUI);
	afx_msg void OnButtonBackNoColor();
	...
	afx_msg void OnUpdateRibbonComboFont(CCmdUI* pCmd);
	afx_msg void OnEditFont(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnUpdateRibbonComboSize(CCmdUI* pCmd);
	afx_msg void OnEditSize(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnButtonTextRibbon();
	afx_msg void OnUpdateTextRibbon(CCmdUI* pCmd);
	afx_msg void OnSelectorTextRibbon(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnUpdateSelectorTextRibbon(CCmdUI* pCmdUI);
	afx_msg void OnUpdateBackNoColorRibbon(CCmdUI* pCmdUI);
	afx_msg void OnButtonBackNoColorRibbon();
