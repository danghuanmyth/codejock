...
class CVisualStudioTreeCtrl : public CXTPOfficeBorder<CTreeCtrl>
{
...
public:
	void SetExplorerTheme(BOOL bExplorerTheme)
	{
		if (XTPSystemVersion()->IsWinVistaOrGreater())
		{
			CXTPWinThemeWrapper().SetWindowTheme(m_hWnd, bExplorerTheme ? L"EXPLORER" : NULL, NULL);
