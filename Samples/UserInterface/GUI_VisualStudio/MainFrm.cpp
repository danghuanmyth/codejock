...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_COMMAND_RANGE(ID_THEME_VC6, ID_THEME_VC10, OnTheme)
	ON_UPDATE_COMMAND_UI_RANGE(ID_THEME_VC6, ID_THEME_VC10, OnUpdateTheme)
...
void CMainFrame::OnTheme(UINT nID)
{
	...
	case ID_THEME_VC10:
		...
		m_wndProperties.m_wndPropertyGrid.SetTheme(xtpGridThemeVisualStudio2010);
		break;
	}
	...
	m_wndSolutionExplorer.m_wndSolutionView.SetExplorerTheme(m_paneManager.GetCurrentTheme() == xtpPaneThemeVisualStudio2010);
	m_wndClassView.m_wndClassView.SetExplorerTheme(m_paneManager.GetCurrentTheme() == xtpPaneThemeVisualStudio2010);
	m_wndResourceView.m_wndResourceView.SetExplorerTheme(m_paneManager.GetCurrentTheme() == xtpPaneThemeVisualStudio2010);
