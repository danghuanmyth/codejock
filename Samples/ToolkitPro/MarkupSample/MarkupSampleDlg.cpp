...
BOOL CMarkupSampleDlg::OnInitDialog()
{
	...
	m_wndStatic.SetMarkupText(
		_T("<Border Padding='4' BorderThickness='1' BorderBrush='#767676' Background='#e4ecf7'>")
		_T("<StackPanel TextBlock.FontFamily='Tahoma'>")
		_T("   <TextBlock Padding='1, 3, 1, 3' FontWeight='Bold'>Change Case</TextBlock>")
		_T("   <TextBlock Padding='9, 6, 30, 7' TextWrapping='Wrap'>Change all the selected text to UPPERCASE, lowercase, or <Hyperlink Tag='hyp1' ToolTip='Some other capitalization'>other</Hyperlink> common capitalizations.</TextBlock>")
		...
		_T("        <Image Source='12'/><TextBlock Margin='7, 0, 0, 0' VerticalAlignment='Center' FontWeight='Bold'>Press F1 for more help.</TextBlock>")
		_T("   </StackPanel>")
		_T("</StackPanel>")
		_T("</Border>"));
	m_wndStatic.GetMarkupContext()->AddHandler(CXTPMarkupHyperlink::m_pClickEvent, CreateMarkupClassDelegate(this, &CMarkupSampleDlg::OnHyperlinkClick));
...
{
	XTP_MARKUP_LISTITEM* pItem = new XTP_MARKUP_LISTITEM(&m_wndList);
