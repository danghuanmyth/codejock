...
BOOL CShortcutPaneCalendar::Create(LPCTSTR lpszCaption, CXTPShortcutBar* pParent)
{
	...
	m_wndCalendar.Create(WS_CHILD|WS_VISIBLE|MCS_NOTODAY, CRect(0, 0, 0, 0), this, 0);

#ifdef _XTP_INCLUDE_CALENDAR
	m_wndCalendar.SetBorderStyle(xtpDatePickerBorderNone);
#endif
...
void CShortcutPaneCalendar::SetFlatStyle(BOOL bFlatStyle)
{
	...
	m_wndTreeCalendar.SendMessage(TVM_SETBKCOLOR, 0, clrBackground); 
	m_wndTreeCalendar.SendMessage(TVM_SETTEXTCOLOR, 0, clrTextColor); 
