...
void CShortcutPaneContacts::SetFlatStyle(BOOL bFlatStyle)
{
	...
	m_wndTreeContacts.SendMessage(TVM_SETBKCOLOR, 0, clrBackground); 
	m_wndTreeContacts.SendMessage(TVM_SETTEXTCOLOR, 0, clrTextColor); 
