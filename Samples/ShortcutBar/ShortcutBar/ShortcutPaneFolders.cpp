...
void CShortcutPaneFolders::SetFlatStyle(BOOL bFlatStyle)
{
	...
	m_wndTreeFolders.SendMessage(TVM_SETBKCOLOR, 0, clrBackground); 
	m_wndTreeFolders.SendMessage(TVM_SETTEXTCOLOR, 0, clrTextColor); 
