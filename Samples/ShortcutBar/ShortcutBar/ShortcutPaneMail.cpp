...
BOOL CShortcutPaneMail::Create(LPCTSTR lpszCaption, CXTPShortcutBar* pParent)
{
	...
	AddItem(_T("Favorite Folders"), &m_wndTreeFavorites, 135);
...
void CShortcutPaneMail::SetFlatStyle(BOOL bFlatStyle)
{
	...
	m_wndTreeMail.SendMessage(TVM_SETBKCOLOR, 0, clrBackground); 
	m_wndTreeMail.SendMessage(TVM_SETTEXTCOLOR, 0, clrTextColor); 
	
	m_wndTreeFavorites.SendMessage(TVM_SETBKCOLOR, 0, clrBackground); 
	m_wndTreeFavorites.SendMessage(TVM_SETTEXTCOLOR, 0, clrTextColor); 
