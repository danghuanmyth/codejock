...
public:
	...
	// Header rows
	BOOL m_bHeaderRowsEnableSelection;
	BOOL m_bHeaderRowsAllowAccess;
	// Options
...
protected:
	...
	afx_msg void OnReportStateChanged(NMHDR *pNotifyStruct, LRESULT *pResult);
	//
	afx_msg void OnHeaderRowsEnableSelection();
	afx_msg void OnHeaderRowsAllowAccess();
	//
	afx_msg void OnRemoveRowEx();
	afx_msg void OnRemoveRecordEx();
	afx_msg void OnSelectFocusedRow();
	afx_msg void OnClearNotifications();
	afx_msg void OnSelchangeBehavior();
	//}}AFX_MSG
#if _XTPLIB_VERSION_PREFIX >= 1520
	afx_msg void OnReportLButtonUp(NMHDR *pNotifyStruct, LRESULT *pResult);
#endif
#if _XTPLIB_VERSION_PREFIX >= 1520
	afx_msg void OnReportHScroll(NMHDR *pNotifyStruct, LRESULT *pResult);
