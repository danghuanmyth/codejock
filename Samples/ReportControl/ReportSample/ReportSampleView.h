...
protected:
	...
	afx_msg void OnScrollingHorizontalBlockCount();
	afx_msg void OnScrollingHorizontalBlockSize();
	afx_msg void OnScrollingHorizontalSmooth();
	afx_msg void OnUpdateScrollingHorizontalBlockCount(CCmdUI *pCmdUI);
	afx_msg void OnUpdateScrollingHorizontalBlockSize(CCmdUI *pCmdUI);
	afx_msg void OnUpdateScrollingHorizontalSmooth(CCmdUI *pCmdUI);
	
	// Scrolling (Vertical)
	afx_msg void OnScrollingVerticalBlockCount();
	afx_msg void OnScrollingVerticalSmooth();
	afx_msg void OnUpdateScrollingVerticalBlockCount(CCmdUI *pCmdUI);
	afx_msg void OnUpdateScrollingVerticalSmooth(CCmdUI *pCmdUI);
	...
	afx_msg void OnOptionsShowFooter();
	afx_msg void OnUpdateOptionsShowFooter(CCmdUI *pCmdUI);
	...
	afx_msg void OnTestPopup();
	afx_msg void OnTestAlternateBackground();
	afx_msg void OnTestDragDrop();
	afx_msg void OnTestHitTest();
	afx_msg void OnTestHeaderAlignment();
	afx_msg void OnTestComboBox();
	afx_msg void OnTestItemTypes();
	...
	// Grid color
	afx_msg void OnGridColorRed();
	afx_msg void OnGridColorGreen();
	afx_msg void OnGridColorBlue();
	afx_msg void OnUpdateGridColorRed  (CCmdUI *pCmdUI);
	afx_msg void OnUpdateGridColorGreen(CCmdUI *pCmdUI);
	afx_msg void OnUpdateGridColorBlue (CCmdUI *pCmdUI);
#endif
	...
	afx_msg void OnReportGroupOrderChanged(NMHDR *pNotifyStruct, LRESULT *pResult);

	afx_msg void OnReportGiveFeedback(NMHDR *pNotifyStruct, LRESULT *pResult);
	DECLARE_MESSAGE_MAP()
