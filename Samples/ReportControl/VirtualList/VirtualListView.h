...
public:
	BOOL m_bColorize;
	BOOL m_bSimpleTree;
	CList<BOOL, BOOL> m_lstCollapsed;
	//CMap<int, int, BOOL, BOOL*> m_mapCollapsedState;
...
protected:
	...
	afx_msg void OnReportSimpleTree();
	afx_msg void OnUpdateReportSimpleTree(CCmdUI* pCmdUI);
