...
BOOL CDialogSampleDlg::OnInitDialog()
{
	...
	SetResize(IDC_SLIDER1,         XTP_ANCHOR_BOTTOMLEFT, XTP_ANCHOR_BOTTOMRIGHT );	
	SetResize(IDC_STATIC_POSITION, XTP_ANCHOR_TOPLEFT, CXTPResizePoint( 0.3f, 1) );
	SetResize(IDC_STATIC_RECT,     CXTPResizePoint( 0.3f, 0), CXTPResizePoint( 0.6f, 1) );
	SetResize(IDC_STATIC_LENGTH,   CXTPResizePoint( 0.6f, 0), CXTPResizePoint( 1, 1) );
