...
class CCustomizePageTools : public CXTPPropertyPage
{
...
// Dialog Data
	...
	CXTPBrowseEdit   m_editToolsDir;
	CXTPBrowseEdit   m_editToolsArg;
	CXTPBrowseEdit   m_editToolsCmd;
	CXTPEditListBox  m_lboxToolsList;
