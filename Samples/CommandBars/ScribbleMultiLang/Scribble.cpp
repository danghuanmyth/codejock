...
#ifndef UNICODE
	::MessageBox(pMainFrame->GetSafeHwnd(), 
		_T("Compile the sample using UNICODE to see Japaneese, Arabic and Russian translations."),
		_T("Some Translations Not Available"), MB_ICONWARNING);
#endif
